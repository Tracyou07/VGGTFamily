"""CPU-only v9 stitching experiment on immutable v8 local window predictions."""
import argparse
...
def execute(args):
    ...
    if args.prediction_set not in ("independent", "overlap_correspondence"):
...
def parse_args(argv=None):
    ...
    parser.add_argument("--prediction-set", choices=("independent", "overlap_correspondence"),
                        required=True)
