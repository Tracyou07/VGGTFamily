"""KITTI camera-center ATE in metres after a proper, positive-scale Sim(3)."""
from __future__ import annotations

from dataclasses import dataclass
import numpy as np

PROTOCOL_ID = "kitti-odometry-ate-sim3-v1"
...
def umeyama_sim3(pred_xyz, gt_xyz) -> Sim3:
    pred, gt = np.asarray(pred_xyz, dtype=float), np.asarray(gt_xyz, dtype=float)
