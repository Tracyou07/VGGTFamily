...
- NRGBD: 16 CPU tests passed; Ruff, Black, `compileall`, shell syntax, and all five backend doctors passed. The read-only nine-scene preflight selected 1,101 frames with fingerprint `408692f30b78f365fabc529bc1c22db16444ebebecac28a062ddad643639a6d0`.
- Published snapshot: all Python files passed AST parsing and all bundled JSON files parsed.
